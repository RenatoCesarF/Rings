...
class Game:
    ...
    def draw_selection_square(self, surface: Surface):
        ...
        self.selected.draw(
            surface,Window.to_isometric_position_from_vector(self.selected_tile_position),
    ...
    def run(self) -> None:
        """The function that runs the game and start the main functions like update and draw"""
        while self.running:
            self.process_events()
            self.update()
            self.draw()
