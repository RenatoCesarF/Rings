...
class Squares:
    def __init__(self, position: Vector, width: int, height: int, color: tuple = (200,0,0)):
        self.color = color
...
while running:
    ...
    pygame.draw.rect(display, square_a.color, pygame.Rect(square_a.position.x,square_a.position.y,square_a.width,square_a.height), width=0)
    pygame.draw.rect(display, square_b.color, pygame.Rect(square_b.position.x,square_b.position.y,square_b.width,square_b.height), width=0)
